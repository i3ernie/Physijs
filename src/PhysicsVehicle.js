...
let Vehicle = function( mesh, tuning ) {
        ...
        this._physijs = {
                id: getObjectId(),
                rigidBody: mesh.PhysicsBody? mesh.PhysicsBody._physijs.id : mesh._physijs.id,
...
Vehicle.prototype = Object.assign( Object.create( THREE.Object3D.prototype ), {
    
    constructor : Vehicle,
    
    addWheel : function( wheel_geometry, wheel_material, connection_point, wheel_direction, wheel_axle, suspension_rest_length, wheel_radius, is_front_wheel, tuning ) {
    ...
    setSteering : function( amount, wheel ) {
    ...
    setBrake : function( amount, wheel ) {
        if ( wheel !== undefined && this.wheels[ wheel ] !== undefined ) {
    ...
    applyEngineForce : function( amount, wheel ) {
        if ( wheel !== undefined && this.wheels[ wheel ] !== undefined ) {
